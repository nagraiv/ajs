# Домашнее задание к лекции «Платформы: браузер vs Node.js» [ссылка](https://github.com/netology-code/ajs-homeworks/tree/ajs8/platforms)
...
Для этого есть команда `npm publish`. 
